...
-- 2017-01-01,MariiaKot,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_MariiaKot')
	 Begin 
	  Alter Database [Assignment07DB_MariiaKot] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_MariiaKot;
	 End
	Create Database Assignment07DB_MariiaKot;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_MariiaKot;
